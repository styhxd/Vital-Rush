...
export const PauseMenu: React.FC<PauseMenuProps> = ({ isPaused, language, gameState, onResume, onSettings, onQuit }) => {
    ...
    return (
        ...
        >
            <div className="flex flex-col gap-3 lg:gap-3 min-w-[250px] lg:min-w-[300px] max-w-sm w-full border-y-2 border-cyan-500 p-5 lg:p-8 bg-[#0a0a1a] shadow-[0_0_50px_rgba(0,255,255,0.15)] relative">
                ...
                <h2 className="text-2xl lg:text-4xl text-cyan-400 font-bold text-center tracking-[0.3em] mb-4 lg:mb-4 text-glow border-b border-cyan-900/50 pb-4 lg:pb-4">
                    {t('PAUSED')}
                </h2>
                
                <button 
                    onClick={(e) => { e.stopPropagation(); onResume(); }}
                    className="w-full py-3 lg:py-4 bg-cyan-900/20 border border-cyan-500/50 hover:bg-cyan-500 hover:text-black text-cyan-100 font-bold text-xs lg:text-base tracking-widest transition-all uppercase group relative overflow-hidden"
                >
                ...
                <button 
                    ...
                    className="w-full py-3 lg:py-4 bg-cyan-900/10 border border-cyan-500/30 hover:bg-cyan-500/20 text-cyan-200 font-bold text-xs lg:text-base tracking-widest transition-all uppercase group relative overflow-hidden"
                >
                ...
                <button 
                    ...
                    className="w-full py-3 lg:py-4 bg-red-900/10 border border-red-500/30 hover:bg-red-600 hover:text-black text-red-400 font-bold text-xs lg:text-base tracking-widest transition-all uppercase mt-2 lg:mt-2 group relative overflow-hidden"
                >
                ...
                <div className="mt-4 lg:mt-4 text-[10px] lg:text-[10px] text-cyan-500/30 font-mono text-center tracking-widest">
