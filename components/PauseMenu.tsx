...
export const PauseMenu: React.FC<PauseMenuProps> = ({ isPaused, language, onResume, onQuit }) => {
    ...
    return (
        // FAILSAFE 2: Z-Index 100 absoluto para garantir sobreposição total ao Canvas.
        // O preventDefault no container impede que toques vazios passem para o jogo.
        <div 
        ...
        >
            <div className="flex flex-col gap-4 min-w-[300px] max-w-sm w-full border-y-2 border-cyan-500 p-8 bg-[#0a0a1a] shadow-[0_0_50px_rgba(0,255,255,0.15)] relative">
                ...
                <h2 className="text-4xl text-cyan-400 font-bold text-center tracking-[0.3em] mb-6 text-glow border-b border-cyan-900/50 pb-4">
                    {t('PAUSED')}
                </h2>
